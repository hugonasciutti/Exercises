...
// Este projeto consiste em ser um TAD que implementa um conjunto matemático, com capacidade
// de criar, inserir, remover, capturar a (cardinalidade, a posição e o i-ésimo de um elemento de X),
// e de destruir os elementos.

// Functions for struct set
